// Voice Streaming Card for Home Assistant
...
(function () {
  ...
  class VoiceStreamingCard extends HTMLElement {
    ...
    updateStatus(status) {
      ...
      this.shadowRoot.getElementById('statusText').textContent = status;
    ...
    updateError() {
      this.shadowRoot.getElementById('errorMessage').textContent = this.errorMessage;
    }
  }
